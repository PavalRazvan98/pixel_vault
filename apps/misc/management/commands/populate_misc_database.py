    ...
    def handle(self, *args, **options):
        ...
        if Platform.objects.count():
            ...
            platforms = [
                Platform(
                    name="PlayStation 4",
                    logo="https://banner2.cleanpng.com/20180729/gzw/09586814236b1e5c271e599460cd515d.webp",
                ),
                Platform(
                    name="Xbox One",
                    logo="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/XBOX_logo_2012.svg/2560px-XBOX_logo_2012.svg.png",
                ),
                Platform(
                    name="Nintendo Switch",
                    logo="https://w7.pngwing.com/pngs/485/678/png-transparent-wii-xbox-360-nintendo-switch-logo-nintendo-text-nintendo-video-game-thumbnail.png",
                ),
                Platform(
                    name="PC",
                    logo="https://i.etsystatic.com/20023820/r/il/2746d9/3407675769/il_fullxfull.3407675769_l1my.jpg",
                ),
                Platform(
                    name="Stadia",
                    logo="https://ssl.gstatic.com/stadia/gamers/assets/stadia_logo_and_text_v1.jpg",
                ),
                Platform(
                    name="PlayStation Vita",
                    logo="https://pbs.twimg.com/profile_images/595306625998675968/s90WosHA_400x400.jpg",
                ),
